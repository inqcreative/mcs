...
(function (global, factory) {
    ...
    function _iterableToArrayLimitLoose(arr, i) {
        ...
        for (
            var _iterator = arr[Symbol.iterator](), _step; !(_step = _iterator.next()).done;
    ...
    function _getDecoratorsApi() {
        ...
        ['method', 'field'].forEach(function (kind) {
            ...
            decorateElement: function (element, placements) {
                ...
                for (
                    var decorators = element.decorators, i = decorators.length - 1; i >= 0; i--
                ) {
                    var keys = placements[element.placement];
    ...
    var defaultOptions = {
        ...
        labelIdle: [
            '<span class="filepond--label-action">Drag & Drop files or Browse</span>',
      Type.STRING
    ],
    ...
    var buildURL = function buildURL() {
        var url = '';
        for (
            var _len = arguments.length, parts = new Array(_len), _key = 0; _key < _len; _key++
        ) {
    ...
    var create$4 = function create(_ref2) {
      ...
      [
        ...
        root.ref.status = root.appendChildView(
            root.createChildView(fileStatus, {
                id: id
            })
        );
    ...
    var create$b = function create(_ref) {
        ...
        attr(label, 'class', 'filepond--dropzone-label');
